...
function BreadcrumbLink({
  ...
  return (
    <Comp
      ...
      className={cn(
        "transition-colors hover:text-foreground focus-visible:text-foreground outline-none", 
        className
      )}
      {...props}
    />
...
function BreadcrumbEllipsis({
  ...
  return (
    <span
      ...
      role="presentation"
      aria-hidden="true"
      className={cn("flex size-7 items-center justify-center rounded-md hover:bg-muted/50 transition-colors", className)}
      {...props}
    >
